...
//construtor de calculadora
    ...
    public double Calculate(){
        ...
        //y - y0 = v0*t + (1/2)*at² : windowHeight = SpeedInWindowPeak * timeInWindow + (1/2) * gravity* timeInWindow²
        ...
        // v = v0+a*t : speedInWindowPeak = 0 + gravity * timeRoofToWindowPeak;
        // TimeRoofToWindowPeak = speedInWindowPeak/gravity + 0
        ...
        //Calculo altura do prédio, que é igual posição final da bola, quando cai no chão
